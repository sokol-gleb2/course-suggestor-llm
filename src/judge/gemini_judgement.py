...
# chat_model = ChatModel.from_pretrained("chat-bison-1")
...
# # Example usage
# job = "Machine Learning Engineer at Meta"
# courses = [
...
# score = query_gemini_for_judgement(job, courses)
# print(f"Gemini judge result: {score}")
